    ...
    <main>
        <div class="wrapper">
            ...
            <div class="abut-us">
                <div class="about-us__text">
                    <h3 class="text__title">Наш бренд</h3>
                ...
                <div class="about-us__img">
                    <img class="column__img first-about__img" src="img/aboutImg1.svg" alt="">
                </div>
            </div>
            <div class="abut-us">
                <div class="about-us__img desctop__img">
                    <img class="column__img" src="img/aboutImg2.jpeg" alt="">
                </div>
                <div class="about-us__text">
                    <p class="text__description">
                ...
                <div class="about-us__img mobile__img">
                    <img class="column__img" src="img/aboutImg2.jpeg" alt="">
                </div>
            ...
            <div class="abut-us">
                <div class="about-us__img desctop__img">
                    <img class="column__img" src="img/aboutImg4.jpeg" alt="">
                </div>
                <div class="about-us__text">
            ...
            <div class="abut-us">
                ...
                <div class="about-us__img">
                    <img class="column__img" src="img/aboutImg5.jpeg" alt="">
                </div>
        ...
        <div class="wrapper">
            <div class="abut-us">
                ...
                <div class="about-us__text">
                    <p class="text__description">
                        <h1 class="mobile__dirrector">Замбурский Анатолий Станиславович</h1><br><br> Член Правления, заместитель Президента — Председателя Правления по инвестиционному и страховому бизнесу.<br> 1995 - 1999 г. — коммерческий директор International Business Consulting.<br>2000
